          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-3">
              {data.skills.map((skill, index) => (
                <div
                  key={index}
                  className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full font-medium text-sm border border-blue-300 hover:bg-blue-200 transition"
                >
        ...
        {data.experience && data.experience.length > 0 && (
          <section>
            ...
            {data.experience.map((exp, index) => (
              <div
                key={index}
                className="mb-4 p-4 rounded-lg shadow-sm bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200"
              >
        ...
        {data.education && data.education.length > 0 && (
          <section>
            ...
            {data.education.map((edu, index) => (
              <div
                key={index}
                className="mb-4 p-4 rounded-lg shadow-sm bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200"
              >
        ...
        {data.certifications && data.certifications.length > 0 && (
          <section>
            ...
            {data.certifications.map((cert, index) => (
              <div
                key={index}
                className="mb-4 p-4 rounded-lg shadow-sm bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200"
              >
        ...
        {data.projects && data.projects.length > 0 && (
          <section>
            ...
            {data.projects.map((proj, index) => (
              <div
                key={index}
                className="mb-4 p-4 rounded-lg shadow-sm bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200"
              >
